				...
				<div class="products-row">
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/h3.png" class="img-responsive" alt="img"></a>
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/h1.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/h2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/h5.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							<div class="new-tag"><h6>14%<br>Off</h6></div>
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/h4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
