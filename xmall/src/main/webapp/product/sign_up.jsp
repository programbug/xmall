		...
		<div class="login-page">
			<div class="container"> 
				...
				<div class="login-body">
					<form action="#" method="post">
						<input type="text" id="username" name="username" placeholder="请输入您的真实姓名" required="required"/>
						<input type="text" id="loginName" name="loginName" placeholder="请输入您的登录名" required="required"/>
						<input type="password" id="password" name="password" placeholder="请输入您的登录密码" required="required"/>
						<input type="text" id="gender" name="dender" placeholder="请输入您的性别" required="required"/>
						<input type="text" id="idCard" name="idCard" placeholder="请输入您的身份证号码" required="required"/>
						<input type="text" id="cellphone" name="cellphone" placeholder="请输入您的电话号码" required="required"/>
						<input type="text" id="email" name="email" placeholder="请输入您的邮箱地址" required="required"/>
						<input type="text" id="birthday" name="birthday" placeholder="请输入您的出生日期" required="required"/>
				...
				<h6>您是否已经有账号？<a href="<%=request.getContextPath()%>/product/login.jsp">是否到登录界面?</a> </h6>  
			</div>
		</div>
