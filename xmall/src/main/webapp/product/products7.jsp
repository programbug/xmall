				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/b1.png" class="img-responsive" alt="img"></a>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/b2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/b3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/b4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/f9.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
