				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/g1.png" class="img-responsive" alt="img"></a>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/g2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/g3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/g4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/g5.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>Sale</h6></div>
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/g6.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
