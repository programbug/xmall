...
<html>
	<head>
		...
		<link href="<%=request.getContextPath()%>/static/css/animate.min.css" rel="stylesheet" type="text/css" media="all" /><!-- animation -->
		...
		<script src="<%=request.getContextPath()%>/static/js/jquery-scrolltofixed-min.js" type="text/javascript"></script><!-- fixed nav js -->
		...
		<div class="contact">
			<div class="container"> 
				<div class="contact-form-row">
					<h3 class="w3ls-title w3ls-title1">给我们留言</h3>  
					<div class="col-md-7 contact-left">
						<form action="#" method="post">
							<input type="text" name="Name" placeholder="Name" required="required">
							<input class="email" type="text" name="Email" placeholder="Email" required="required">
