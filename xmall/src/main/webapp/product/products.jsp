		...
		<div class="header">
			...
			<div class="header-two"><!-- header-two -->
				<div class="container">
					<div class="header-logo">
						<h1><a href="<%=request.getContextPath()%>/product/index.jsp">
							<span>W</span>xmall<i>Buy</i></a>
						</h1>
						<h6>你的商店，你的欢乐</h6> 
					</div>	
					<div class="header-search">
						<form action="#" method="post">
							<input type="search" name="Search" placeholder="请输入查找商品">
					...
					<div class="header-cart"> 
						<div class="my-account">
							<a href="<%=request.getContextPath()%>/product/contact.jsp">
			...
			<div class="header-three"><!-- header-three -->
				<div class="container">
							...
							<nav class="cd-dropdown"> 
								...
								<ul class="cd-dropdown-content"> 
									...
									<li class="has-children">
										...
										<ul class="cd-secondary-dropdown is-hidden">
											<li class="go-back"><a href="#">菜单</a></li>
											<li class="see-all"><a href="<%=request.getContextPath()%>/product/products1.jsp">所有时装店</a></li>
											<li class="has-children">
												<a href="#">女士服装</a> 
												<ul class="is-hidden">  
					...
					<div class="move-text">
						<div class="marquee">
							<a href="<%=request.getContextPath()%>/product/offers.jsp">
								这里有新的系列......
								<span>
		...
		<div class="container">
			<div class="col-md-9 product-w3ls-right">
				...
				<ol class="breadcrumb breadcrumb1">
					<li><a href="<%=request.getContextPath()%>/product/index.jsp">首页</a></li>
				...
				<div class="product-top">
					...
					<ul> 
						<li class="dropdown head-dpdn">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">过滤<span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="#">低价</a></li> 
								<li><a href="#">高价</a></li>
								<li><a href="#">最新</a></li> 
				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="<%=request.getContextPath()%>/product/single.jsp">
								<img src="<%=request.getContextPath()%>/static/images/e1.png" class="img-responsive" alt="img">
							</a>
							<div class="agile-product-text">              
								<h5><a href="single.html">音频扬声器</a></h5> 
								<h6><del>200元</del> 100元</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="<%=request.getContextPath()%>/product/single.jsp">
								<img src="<%=request.getContextPath()%>/static/images/e2.png" class="img-responsive" alt="img">
							</a>
							<div class="agile-product-text">              
								<h5><a href="<%=request.getContextPath()%>/product/single.jsp">冰箱</a></h5> 
								<h6><del>4000元</del>3000元</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							<div class="new-tag"><h6>5% <br> 折扣</h6></div>
							<a href="<%=request.getContextPath()%>/product/single.jsp">
								<img src="<%=request.getContextPath()%>/static/images/e3.png" class="img-responsive" alt="img">
							</a>
							<div class="agile-product-text">              
								<h5><a href="<%=request.getContextPath()%>/product/single.jsp">智能手机</a></h5> 
								<h6><del>5000元</del>4700元</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>新</h6></div>
							<a href="<%=request.getContextPath()%>/product/single.jsp">
								<img src="<%=request.getContextPath()%>/static/images/e4.png" class="img-responsive" alt="img">
							</a>
							<div class="agile-product-text">              
								<h5><a href="<%=request.getContextPath()%>/product/single.jap">数码相机</a></h5> 
								<h6><del>10000元</del>8880元</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5><a href="<%=request.getContextPath()%>/product/single.jsp">数码相机</a></h5> 
								<h6><del>10000元</del>8880元</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5><a href="<%=request.getContextPath()%>/product/single.jsp">音频扬声器</a></h5> 
								<h6><del>200元</del>100元</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5><a href="<%=request.getContextPath()%>/product/single.jsp">Audio speaker</a></h5> 
			...
			<div class="col-md-3 rsidebar">
				<div class="rsidebar-top">
					<div class="slider-left">
						...
						<div class="row row1 scroll-pane">
							<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>1 - 1000</label>
							<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>1200 - 3000</label> 
							<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>3200 - 5000</label> 
							<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>5100 - 7500</label> 
							<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>7600 - 8500</label> 
							<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>8600 - 10000</label> 
						...
						<ul class="faq">
							<li class="item1"><a href="#">手机<span class="glyphicon glyphicon-menu-down"></span></a>
								<ul>
									...
									<li class="subitem1"><a href="#">饰品</a></li>										
									<li class="subitem1"><a href="#">标签</a></li>										
								</ul>
							</li>
							<li class="item2"><a href="#">大家电<span class="glyphicon glyphicon-menu-down"></span></a>
								<ul>
									<li class="subitem1"><a href="#">冰箱</a></li>										
									<li class="subitem1"><a href="#">洗衣机</a></li>										
									<li class="subitem1"><a href="#">厨房家电</a></li>										
									<li class="subitem1"><a href="#">冷气机</a></li>										
								</ul>
							</li>
							<li class="item3"><a href="#">娱乐<span class="glyphicon glyphicon-menu-down"></span></a>
								<ul>
									<li class="subitem1"><a href="#">电视和配件</a></li>										
					...
					<div class="sidebar-row">
						<h4>折扣</h4>
						<div class="row row1 scroll-pane">
							<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>高达 - 10% (20)</label>
					...
					<div class="sidebar-row">
						...
						<div class="row row1 scroll-pane">
							...
							<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>粉</label>
							<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>金</label>
				...
				<div class="related-row">
					<h4>相关搜索</h4>
					<ul>
						<li><a href="products.html">冷气机</a></li>
						<li><a href="products.html">娱乐</a></li>
						<li><a href="products.html">显示器</a></li>
						<li><a href="products.html">个人电脑</a></li>
						<li><a href="products.html">食品加工商</a></li>
						<li><a href="products.html">烤箱</a></li>
						<li><a href="products.html">净化器</a></li>
						<li><a href="products.html">清洁工</a></li>
						<li><a href="products.html">小设备</a></li>
					</ul>
				</div>
				<div class="related-row">
					<h4>您也许也喜欢</h4>
					<div class="galry-like">  
						...
						<h4><a href="products.html">音频扬声器</a></h4> 
						<h5>100元</h5>       
					</div>
				</div>
			</div>
