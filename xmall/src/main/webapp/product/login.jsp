...
<html>
	...
	<body>
		...
		<div class="login-page">
			<div class="container"> 
				<h3 class="w3ls-title w3ls-title1">请登录您的账户</h3>  
				<div class="login-body">
					<form action="<%=request.getContextPath()%>/product/index.jsp" method="post">
						<input type="text" class="user" name="email" placeholder="请输入您的用户名" required="required">
						<input type="password" name="password" class="lock" placeholder="请输入您的密码" required="required">
