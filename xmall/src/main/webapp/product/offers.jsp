...
<html>
	...
	<link href="<%=request.getContextPath()%>/static/css/animate.min.css" 
			rel="stylesheet" type="text/css" media="all" /><!-- animation -->
	...
	<body>
			...
			<div class="header-two"><!-- header-two -->
				<div class="container">
					<div class="header-logo">
						<h1>
							<a href="<%=request.getContextPath()%>/product/index.jsp">
								<span>W</span>xmall<i>Buy</i>
							</a>
						</h1>
						<h6>你的商店，你的欢乐</h6> 
					</div>	
		...
		<div class="wthree-offers">
			<div class="container">
				<h3 class="w3ls-title w3ls-title1">今日优惠及礼品卡</h3>
				<div class="w3ls-add-grids w3agile-add-products">
					<a href="#"> 
						<h4>10大趋势为你带来<span>20%</span>折扣</h4>
						<h6>现在去购物<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></h6>
					</a>
				</div> 
				<div class="offer-card-row">
					<div class="col-md-4 offer-card-grids">
						<h4>20%现金返还</h4>
						<p>使用礼品卡购物获得20％的现金返还</p>
