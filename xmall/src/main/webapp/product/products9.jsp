				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/m1.png" class="img-responsive" alt="img"></a>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/m2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/m3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="<%=request.getContextPath()%>/static/images/m4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
